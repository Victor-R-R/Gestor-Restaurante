...
# dandole funcionalidad a la calculadora
operador = ""
...
def recibo():
    ...
    texto_recibo.insert(END, "Producto\t\tCant.\tPrecio\n")
    ...
    texto_recibo.insert(END, f"Precio de la Postre: \t\t\t{var_costo_postres.get()}\n")
    texto_recibo.insert(END, f"-" * 63 + "\n")
...
# Resetear la aplicacion para empezar de 0
def resetear():
...
# etiquetas de costo comida y los campos de entrada
...
# etiquetas de costo bebida y los campos de entrada
...
# etiquetas de costo postres y los campos de entrada
...
# etiquetas de impuestos y los campos de entrada
...
texto_total.grid(row=2, column=3, padx=105)
...
# area de recibo
texto_recibo = Text(panel_recibo, font=("Dosis", 12, "bold"), bd=1, width=56, height=10)
